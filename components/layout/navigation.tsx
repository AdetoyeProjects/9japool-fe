    ...
    <nav className="w-full bg-slate-800 px-4 py-4">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <Button variant="ghost" onClick={openLoginModal} className="text-white hover:text-green-400 hover:bg-transparent cursor-pointer font-medium">
            Login
          </Button>
          <Button onClick={openLoginModal} className="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded-lg font-medium cursor-pointer">
            Sign Up
          </Button>
        </div>
      </div>
